...
cdata1 = pd.read_csv('Mass.csv', encoding='ISO-8859-1', sep=',' ,low_memory=False)
data = cdata1
cdata1 = pd.read_csv('Mass.csv', encoding = "ISO-8859-1", parse_dates=["Date"],low_memory=False)


dff = pd.read_csv('own.csv',low_memory=False)
...
# 读取“枪支暴力”数据集
df = pd.read_csv('guns.csv', encoding='ISO-8859-1', sep=',' ,low_memory=False)
df.head()
dd= dff[['Country','Average']]
dd1=dd.sort_values('Average',ascending=False)
dd2=dd1.head(21)
...
dfs = pd.read_csv('Mass_nd.csv', encoding='ISO-8859-1', sep=',',low_memory=False)
...
regions_availables = ["the_description.html", "Number_of_guns.html", "shooting.html",
                       "Injured_person.html", "Las_Vegas_shootings.html",
                      "Number_of_shootings.html", "Suspects.html", "frequent_words.html",
                       "Who_was_attacked.html",
                      "the_top_20_states.html",
                      "where.html"]
...
# 准备工作
# pandas 大法读内容, 用dropna()丢缺失值, 用unique()取唯一值, 不重覆
df = pd.read_csv('Mass_nd.csv', encoding='ISO-8859-1', sep=',',low_memory=False)
...
def previous():
    return render_template("page_13_total_thing.html",the_select_one=regions_availables)


@app.route('/select',methods=["POST"])
def select():
    the_region_selected = request.form["the_region_selected"]
    if the_region_selected == "the_description.html":
        return render_template('page_00_the_description.html')
    elif the_region_selected == "Number_of_guns.html":
        return render_template('page_01_Number_of_guns.html',
                               bar=overlap_line_scatter())
    elif the_region_selected == "shooting.html":
        return render_template("page_02_shooting.html")
    elif the_region_selected == "Injured_person.html":
        return render_template("page_04_Injured_person.html")
    elif the_region_selected == "Las_Vegas_shootings.html":
        people = cdata1.sort_values(by="total", ascending=False)
        data_str = people.to_html()
        return render_template("page_05_Las_Vegas_shootings.html",
                               the_res=data_str
                               )
    elif the_region_selected =="Number_of_shootings.html":
        return render_template("page_06_Number_of_shootings.html")
    elif the_region_selected== "Suspects.html":
        return render_template("page_07_Suspects.html",
                               suspects=total()
                               )
    elif the_region_selected=="frequent_words.html":
        return render_template("page_08_frequent_words.html",
                               )
    elif the_region_selected =="Who_was_attacked.html":
        return render_template("page_10_Who_was_attacked.html",
                               )
    elif the_region_selected == "the_top_20_states.html":
        return render_template("page_11_the_top_20_states.html")
    elif the_region_selected == "where.html":
        return render_template("page_12_where.html")
